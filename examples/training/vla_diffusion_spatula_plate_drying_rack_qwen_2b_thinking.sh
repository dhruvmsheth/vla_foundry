...
# Train a Qwen3VLA SFT checkpoint for BimanualPutSpatulaOnPlateFromDryingRack.
# This is the closest public-data RECAP candidate to the utensil-crock plate task.
